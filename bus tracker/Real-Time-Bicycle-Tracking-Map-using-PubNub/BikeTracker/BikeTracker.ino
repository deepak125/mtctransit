...
char pubkey[] = "pub-c-3588af66-9bbd-4984-b578-27f5877f17db";
char subkey[] = "sub-c-598e4d8e-e9e4-11e4-91d3-0619f8945a4f";
char channel[] = "Kcteee";
...
void setup()
{
    ...
    //attachGPRS(const char *apn, const char *username, const char *password);
     ...
     while (!LGPRS.attachGPRS("Airtel GPRS", "airtelgprs.com", "")) 
    {
    Serial.println(" . ");
    delay(1000);
    }
